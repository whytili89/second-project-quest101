...
class CommentTest(TestCase):
    ...
    def test_comment_post_success(self):
        ...
        response = client.post('/products/2/comment',json.dumps(comment),**header, content_type='application/json')
    ...
    def test_comment_post_key_error(self):
        ...
        response = client.post('/products/1/comment',json.dumps(comment),**header, content_type='application/json')
        self.assertEqual(response.json(), {'message':'KEY_ERROR'})
        self.assertEqual(response.status_code, 401)

    def test_comment_get_success(self):
        client = Client()
        response = client.get('/products/1/comment')
    ...
    def test_comment_delete_success(self): 
        ...
        response = client.delete('/products/1/comment',json.dumps(body),**header)
